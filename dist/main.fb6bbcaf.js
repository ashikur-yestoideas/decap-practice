...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"js/github.js":[function(require,module,exports) {
var define;
"use strict";
...
exports.initializeGitHub = initializeGitHub;
...
var envVariables = undefined;
console.log("env", envVariables);
var GITHUB_TOKEN = '';
var REPO_OWNER = 'ashikur-yestoideas';
var REPO_NAME = 'decap-practice';
var POSTS_PATH = 'posts';
var octokit;
function initializeGitHub() {
  return _initializeGitHub.apply(this, arguments);
}
function _initializeGitHub() {
  _initializeGitHub = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var _yield$import, Octokit;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
          return import('https://cdn.skypack.dev/@octokit/core');
        case 2:
...
function _getPosts() {
  _getPosts = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
    var postId,
      response,
      content,
      _response,
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          postId = _args3.length > 0 && _args3[0] !== undefined ? _args3[0] : null;
          _context3.prev = 1;
          if (!postId) {
            _context3.next = 10;
            break;
          ...
          _context3.next = 5;
          return octokit.request('GET /repos/{owner}/{repo}/contents/{path}/{file}', {
            owner: REPO_OWNER,
            repo: REPO_NAME,
            path: POSTS_PATH,
            file: "".concat(postId, ".md")
          });
        case 5:
        ...
        case 12:
          ...
          _context3.next = 15;
          return Promise.all(_response.data.map(/*#__PURE__*/function () {
            var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(file) {
              ...
              return _regeneratorRuntime().wrap(function _callee2$(_context2) {
                while (1) switch (_context2.prev = _context2.next) {
                  case 0:
                    _context2.next = 2;
                    return getPosts(file.name.replace('.md', ''));
                  case 2:
...
function _createPost() {
  _createPost = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee4(title, content) {
    var postId, postContent;
      ...
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          ...
          return octokit.request('PUT /repos/{owner}/{repo}/contents/{path}', {
            owner: REPO_OWNER,
            repo: REPO_NAME,
            path: "".concat(POSTS_PATH, "/").concat(postId, ".md"),
            message: "Create post: ".concat(title),
            content: btoa(postContent)
          });
        case 5:
          return _context4.abrupt("return", postId);
        case 8:
          _context4.prev = 8;
...
function updatePost(_x3, _x4, _x5) {
  return _updatePost.apply(this, arguments);
}
function _updatePost() {
  _updatePost = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee5(postId, title, content) {
    var postContent, currentFile;
      ...
      while (1) switch (_context5.prev = _context5.next) {
        ...
        case 4:
          ...
          return octokit.request('PUT /repos/{owner}/{repo}/contents/{path}', {
            ...
            repo: REPO_NAME,
            path: "".concat(POSTS_PATH, "/").concat(postId, ".md"),
            message: "Update post: ".concat(title),
            content: btoa(postContent),
        ...
        case 9:
          ...
          console.error('Error updating post:', _context5.t0);
        case 12:
        case "end":
...
function _deletePost() {
  _deletePost = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee6(postId) {
    var currentFile;
      ...
      while (1) switch (_context6.prev = _context6.next) {
        ...
        case 3:
          ...
          return octokit.request('DELETE /repos/{owner}/{repo}/contents/{path}', {
            ...
            repo: REPO_NAME,
            path: "".concat(POSTS_PATH, "/").concat(postId, ".md"),
            message: "Delete post: ".concat(postId),
            sha: currentFile.data.sha
          });
        case 6:
          _context6.next = 11;
        ...
        case 8:
          ...
          console.error('Error deleting post:', _context6.t0);
        case 11:
        case "end":
...
function parsePostContent(content) {
  var _content$split = content.split('---'),
    ...
    frontMatter = _content$split2[1],
    body = _content$split2[2];
  var metadata = {};
...
},{}],"js/comments.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.setupComments = setupComments;
...
function loadComments(_x2, _x3) {
  return _loadComments.apply(this, arguments);
}
function _loadComments() {
  _loadComments = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(postId, container) {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          _context2.next = 3;
          return _github.octokit.request('GET /repos/{owner}/{repo}/contents/{path}', {
            owner: _github.REPO_OWNER,
            repo: _github.REPO_NAME,
            path: "".concat(COMMENTS_PATH, "/").concat(postId, ".json")
          });
        case 3:
        ...
        case 8:
          ...
          console.error('Error loading comments:', _context2.t0);
...
function renderComments(comments, container) {
  container.innerHTML = comments.map(function (comment) {
    return "\n        <div class=\"comment\">\n            <h4>".concat(comment.author, "</h4>\n            <p>").concat(comment.content, "</p>\n            <small>").concat(new Date(comment.date).toLocaleString(), "</small>\n        </div>\n    ");
  }).join('');
}
...
function _addComment() {
  _addComment = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3(postId, author, content) {
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 11:
          ...
          _context3.next = 14;
          return _github.octokit.request('PUT /repos/{owner}/{repo}/contents/{path}', {
            owner: _github.REPO_OWNER,
            repo: _github.REPO_NAME,
            path: "".concat(COMMENTS_PATH, "/").concat(postId, ".json"),
            message: "Add comment to post ".concat(postId),
        ...
        case 16:
          ...
          console.error('Error adding comment:', _context3.t1);
        case 19:
        case "end":
          return _context3.stop();
      }
    }, _callee3, null, [[0, 16], [2, 9]]);
  }));
  return _addComment.apply(this, arguments);
}
},{"./github.js":"js/github.js"}],"node_modules/codemirror/lib/codemirror.js":[function(require,module,exports) {
var define;
...
},{"../../lib/codemirror":"node_modules/codemirror/lib/codemirror.js","../markdown/markdown":"node_modules/codemirror/mode/markdown/markdown.js","../../addon/mode/overlay":"node_modules/codemirror/addon/mode/overlay.js"}],"C:/Users/Computer World/AppData/Roaming/nvm/v18.20.3/node_modules/parcel-bundler/src/builtins/_empty.js":[function(require,module,exports) {

},{}],"node_modules/typo-js/typo.js":[function(require,module,exports) {
var __dirname = "D:\\New-Volume(D)\\yestoideas-company-projects\\demo-blog-project\\node_modules\\typo-js";
...
},{"fs":"C:/Users/Computer World/AppData/Roaming/nvm/v18.20.3/node_modules/parcel-bundler/src/builtins/_empty.js"}],"node_modules/codemirror-spell-checker/src/js/spell-checker.js":[function(require,module,exports) {
...
},{"typo-js":"node_modules/typo-js/typo.js"}],"node_modules/marked/lib/marked.umd.js":[function(require,module,exports) {
var define;
var global = arguments[3];
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
/**
...
function _renderHome() {
  _renderHome = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var posts;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
          return (0, _github.getPosts)();
        case 2:
          posts = _context.sent;
          content.innerHTML = "\n        <h1>Recent Posts</h1>\n        <ul class=\"list-group\">\n            ".concat(posts.map(function (post) {
            return "\n                <li class=\"list-group-item\">\n                    <h2>".concat(post.title, "</h2>\n                    <p>").concat(post.content.substring(0, 100), "...</p>\n                    <a href=\"#\" class=\"btn btn-primary view-post\" data-post-id=\"").concat(post.id, "\">View</a>\n                    <a href=\"#\" class=\"btn btn-secondary edit-post\" data-post-id=\"").concat(post.id, "\">Edit</a>\n                    <a href=\"#\" class=\"btn btn-danger delete-post\" data-post-id=\"").concat(post.id, "\">Delete</a>\n                </li>\n            ");
          }).join(''), "\n        </ul>\n    ");
        case 4:
        case "end":
          return _context.stop();
...
function renderEditor() {
  ...
  content.innerHTML = "\n        <h1>".concat(post ? 'Edit Post' : 'New Post', "</h1>\n        <form id=\"postForm\">\n            <div class=\"mb-3\">\n                <label for=\"postTitle\" class=\"form-label\">Title</label>\n                <input type=\"text\" class=\"form-control\" id=\"postTitle\" value=\"").concat(post ? post.title : '', "\" required>\n            </div>\n            <div class=\"mb-3\">\n                <label for=\"postContent\" class=\"form-label\">Content</label>\n                <textarea class=\"form-control\" id=\"postContent\" rows=\"10\" required>").concat(post ? post.content : '', "</textarea>\n            </div>\n            <button type=\"submit\" class=\"btn btn-primary\">").concat(post ? 'Update' : 'Create', " Post</button>\n        </form>\n    ");
  editor = new _easymde.default({
    element: document.getElementById('postContent')
  });
}
function renderPost(_x) {
  return _renderPost.apply(this, arguments);
}
function _renderPost() {
  _renderPost = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(post) {
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          content.innerHTML = "\n        <h1>".concat(post.title, "</h1>\n        <div class=\"post-content\">").concat(marked(post.content), "</div>\n        <hr>\n        <h3>Comments</h3>\n        <div id=\"comments\"></div>\n        <form id=\"commentForm\">\n            <div class=\"mb-3\">\n                <label for=\"commentAuthor\" class=\"form-label\">Name</label>\n                <input type=\"text\" class=\"form-control\" id=\"commentAuthor\" required>\n            </div>\n            <div class=\"mb-3\">\n                <label for=\"commentContent\" class=\"form-label\">Comment</label>\n                <textarea class=\"form-control\" id=\"commentContent\" rows=\"3\" required></textarea>\n            </div>\n            <button type=\"submit\" class=\"btn btn-primary\">Add Comment</button>\n        </form>\n    ");
          (0, _comments.setupComments)(post.id);
        case 2:
        case "end":
          return _context2.stop();
      }
...
},{"./github.js":"js/github.js","./comments.js":"js/comments.js","easymde":"node_modules/easymde/src/js/easymde.js"}],"js/search.js":[function(require,module,exports) {
"use strict";
...
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; }
function setupSearch(searchInput, searchButton, renderSearchResults) {
  searchButton.addEventListener('click', /*#__PURE__*/function () {
    var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
      var query, posts, results;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            e.preventDefault();
...
},{"./github.js":"js/github.js"}],"js/main.js":[function(require,module,exports) {
"use strict";
  ...
  _init = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _context3.next = 2;
          return (0, _github.initializeGitHub)();
        case 2:
          setupEventListeners();
          (0, _ui.renderHome)();
          (0, _search.setupSearch)(searchInput, searchButton, renderSearchResults);
        case 5:
        case "end":
          return _context3.stop();
      }
...
function setupEventListeners() {
  ...
  content.addEventListener('click', /*#__PURE__*/function () {
    var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
      var postId, _postId, _postId2;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 5;
            return (0, _github.getPosts)(postId);
          case 5:
            currentPost = _context.sent;
            (0, _ui.renderEditor)(currentPost);
            _context.next = 25;
            break;
          case 9:
            ...
            e.preventDefault();
            _postId = e.target.dataset.postId;
            if (!confirm('Are you sure you want to delete this post?')) {
              _context.next = 16;
              break;
            }
            _context.next = 15;
            return (0, _github.deletePost)(_postId);
          case 15:
            (0, _ui.renderHome)();
          case 16:
            _context.next = 25;
          ...
          case 18:
            ...
            e.preventDefault();
            _postId2 = e.target.dataset.postId;
            _context.next = 23;
            return (0, _github.getPosts)(_postId2);
          case 23:
            currentPost = _context.sent;
            (0, _ui.renderPost)(currentPost);
          case 25:
          case "end":
            return _context.stop();
        }
  ...
  content.addEventListener('submit', /*#__PURE__*/function () {
      ...
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _content = document.getElementById('postContent').value;
            if (!currentPost) {
              _context2.next = 9;
              break;
            }
            _context2.next = 7;
            return (0, _github.updatePost)(currentPost.id, title, _content);
          case 7:
            _context2.next = 11;
            break;
          case 9:
            _context2.next = 11;
            return (0, _github.createPost)(title, _content);
          case 11:
            (0, _ui.renderHome)();
          case 12:
          case "end":
...
function renderSearchResults(results) {
  content.innerHTML = "\n        <h2>Search Results</h2>\n        <ul class=\"list-group\">\n            ".concat(results.map(function (post) {
    return "\n                <li class=\"list-group-item\">\n                    <h3>".concat(post.title, "</h3>\n                    <p>").concat(post.content.substring(0, 100), "...</p>\n                    <a href=\"#\" class=\"btn btn-primary view-post\" data-post-id=\"").concat(post.id, "\">View</a>\n                    <a href=\"#\" class=\"btn btn-secondary edit-post\" data-post-id=\"").concat(post.id, "\">Edit</a>\n                    <a href=\"#\" class=\"btn btn-danger delete-post\" data-post-id=\"").concat(post.id, "\">Delete</a>\n                </li>\n            ");
  }).join(''), "\n        </ul>\n    ");
}
init();
},{"./github.js":"js/github.js","./ui.js":"js/ui.js","./search.js":"js/search.js","./comments.js":"js/comments.js"}],"C:/Users/Computer World/AppData/Roaming/nvm/v18.20.3/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["C:/Users/Computer World/AppData/Roaming/nvm/v18.20.3/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/main.js"], null)
